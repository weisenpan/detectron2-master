...
if __name__ == "__main__":
    if os.path.exists('inference0.csv'):
        print("Old inference0.csv Exists! Delete Or Move It, And Try Again!")
        sys.exit(0)
    args = default_argument_parser().parse_args()
    args.config_file = "configs/COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_1x.yaml"
    args.num_gpus = 0
    args.opts = ['SOLVER.IMS_PER_BATCH', '1', 'SOLVER.BASE_LR', '0.0025', 'TEST.EVAL_PERIOD', '1000', 'SEED', '123', 'OUTPUT_DIR', 'train0']
